...
const pageMeta: Record<PageKey, PageMetaData> = {
    home: {
        ...
        canonical: 'https://www.digitalgrowx.com',
    ...
    about: {
        ...
        canonical: 'https://www.digitalgrowx.com/about',
    ...
    services: {
        ...
        canonical: 'https://www.digitalgrowx.com/services',
    ...
    contact: {
        ...
        canonical: 'https://www.digitalgrowx.com/appointment',
    ...
    clients: {
        ...
        canonical: 'https://www.digitalgrowx.com/our-clients',
